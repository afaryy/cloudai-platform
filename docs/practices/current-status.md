...
- **P7 AI Factory / LLMOps / GPU stretch:** retain the [AI Factory infrastructure lens](../architecture/ai-factory-infrastructure-lens.md), [AI Workload Operating Contract](./ai-workload-operating-contract.md), and [GPU workload readiness](../architecture/ai-factory-gpu-workload-readiness.md) as future design context; they define workload readiness and AI data-centre practice boundaries, not a current GPU, scheduler, or AI Factory implementation.
