...
| YY-52 VPC-connected CodeBuild runner foundation | Remote-state consumer and protected lifecycle source implemented; dedicated runner-state OIDC role and runtime validation pending | `providers/aws/infra/terraform/modules/private-runner/`, `providers/aws/infra/terraform/envs/eks-private-runner/`, `.github/workflows/terraform-eks-private-runner.yml`, and `docs/solutions/vpc-connected-runner-runbook.md` |
