...
| AgentCore governed RAG POC | Local implementation and mock-only validation complete; deployment not approved or performed | `providers/aws/app/agentcore-rag-runtime/`, `providers/aws/agentcore/`, `providers/aws/scripts/agentcore-rag-*.mjs`, `docs/architecture/agentcore-governed-rag-poc.md`, and `docs/solutions/agentcore-governed-rag-poc-runbook.md` |
