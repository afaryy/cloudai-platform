...
| --- | --- | --- |
| Workload contract | Documentation-first service, batch, fine-tuning, and distributed-training profiles; synthetic Agent/RAG, batch, fine-tuning, and distributed-training fixtures with contract tests | Add embeddings/RAG-indexing fixture when a new readiness decision requires it |
