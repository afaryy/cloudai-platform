...
This synthetic demo script explains the repository story without requiring live cloud access.

## Flow

1. Introduce the AWS-first, multi-cloud-ready control-plane goal.
2. Show the architecture and provider abstraction documents.
