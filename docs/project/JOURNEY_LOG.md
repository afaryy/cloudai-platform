...
<!-- TODO: Future automation can generate milestone entries from docs/project/status.json and prompt execution summaries. -->
...
- Added this lightweight Agile project control pack.
