...
type TestEvidenceFamily = ReturnType<typeof evidence> & {
  remediation?: {
    owner: string;
    dueAt: string;
...
type TestAssessment = {
  ...
  assessedAt: string;
  reviewBy: string;
  evidenceFamilies: TestEvidenceFamily[];
  externalRequirements: ReturnType<typeof requirement>[];
  evidenceReferences: string[];
};

const BASE_ASSESSMENT: TestAssessment = {
  schemaVersion: "1.0",
